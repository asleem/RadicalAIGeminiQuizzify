...
if __name__ == "__main__":
    ...
    # Add Session State
    if 'question_bank' not in st.session_state or st.session_state['question_bank'] is None or len(st.session_state['question_bank']) == 0:
        ##### YOUR CODE HERE #####
    ...
    if st.session_state.get("display_quiz"):
        ...
        with st.container():
            ...
            with st.form("MCQ"):
                ...
                next_question = st.form_submit_button("Next Question", on_click=lambda: quiz_manager.next_question_index(1))
                previous_question = st.form_submit_button(
                    "Previous Question", on_click=lambda: quiz_manager.next_question_index(-1))
                ##### YOUR CODE HERE #####
